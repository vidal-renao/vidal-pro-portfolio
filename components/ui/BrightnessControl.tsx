    ...
    <div className="fixed bottom-20 right-4 sm:bottom-5 sm:right-5 z-9999">
      {visible ? (
        <div className="flex flex-col gap-3 rounded-2xl border border-white/[0.1] bg-[#0d0d0d]/95 p-4 shadow-2xl backdrop-blur-md w-48">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-white/60 hover:text-white/70 transition-colors text-xs"
              aria-label="Close"
            >
              ✕
            </button>
          ...
          <div className="flex items-center justify-between">
            ...
            {brightness !== 100 && (
              <button
                onClick={reset}
                className="text-[10px] text-white/60 hover:text-white/65 transition-colors"
              >
                Reset
              </button>
            )}
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-white/[0.1] bg-[#0d0d0d]/80 text-white/60 shadow-lg backdrop-blur-sm transition-all duration-200 hover:border-blue-500/40 hover:text-blue-400"
        >

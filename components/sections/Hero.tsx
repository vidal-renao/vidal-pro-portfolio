  ...
  return (
    <section className="relative flex flex-col justify-center overflow-hidden grid-bg">
        ...
        <div className="grid sm:min-h-[calc(100vh-120px)] items-center gap-6 sm:gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="order-2 flex flex-col items-start gap-6 lg:order-1">
            <div className="flex flex-col gap-2">
              <div
                className="reveal-up flex w-fit items-center gap-2 rounded-full border border-white/[0.1] bg-white/[0.03] px-4 py-1.5 text-xs text-white/60"
              >
              ...
              <div
                ...
                className="reveal-up flex w-fit items-center gap-2 rounded-full border border-amber-500/25 bg-amber-500/5 px-4 py-1.5 text-xs text-amber-300/80"
              >
              ...
              <div
                ...
                className="reveal-up flex w-fit items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/5 px-4 py-1.5 text-xs text-sky-200/85"
              >
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="flex items-center gap-1.5 text-xs text-white/60">
                <svg className="h-3.5 w-3.5 flex-none text-blue-300/80" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <motion.a
                ...
                className="group flex items-center gap-2 rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition-all duration-200 hover:bg-blue-700"
            ...
            <div
              ...
              className="reveal-up flex w-full items-center gap-4 sm:gap-8 border-t border-white/[0.06] pt-6"
            >
              {[
          ...
          <div className="reveal-in order-1 flex justify-center lg:order-2 lg:justify-end">
            <div className="relative">
              ...
              <div
                ...
                className="reveal-up glass-card absolute -bottom-3 -left-4 flex items-center gap-2 rounded-xl border border-white/[0.1] px-3 py-2"
              >
                <span className="text-base">CH</span>
                <div>
                  <p className="text-xs font-semibold leading-none text-white">Basel, Switzerland</p>
                  <p className="mt-0.5 text-[10px] text-white/60">EN C1 · DE B2 · ES Native</p>
                </div>
              </div>

              <div
                style={{ animationDelay: "0.6s" }}
                className="reveal-up glass-card absolute -right-4 -top-2 flex items-center gap-2 rounded-xl border border-blue-500/20 bg-blue-500/5 px-3 py-2"
              >
      ...
      <div
        ...
        className="reveal-up absolute bottom-6 left-1/2 -translate-x-1/2"
      >
